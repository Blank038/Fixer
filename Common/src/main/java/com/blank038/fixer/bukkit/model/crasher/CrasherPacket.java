package com.blank038.fixer.bukkit.model.crasher;

import com.blank038.fixer.bukkit.Fixer;
import com.blank038.fixer.bukkit.model.crasher.protocol.PacketListenerApiModel;
import com.blank038.fixer.bukkit.model.crasher.protocol.ProtocolLibModel;
...
public class CrasherPacket implements Listener {
    ...
    public static class CrasherData {
        ...
        public boolean checkStatus() {
            if (System.currentTimeMillis() - latestTime >= Fixer.getCheckList().crashServerDelay) {
